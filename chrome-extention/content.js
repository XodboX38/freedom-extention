if (window.__FREEDOM_CONTENT_SCRIPT_LOADED__) {
  // Already loaded → skip
  console.log("FreeDOM: content.js already active, skipping re-injection.");
} else {
  window.__FREEDOM_CONTENT_SCRIPT_LOADED__ = true;

  // --- all your content.js code goes here ---
